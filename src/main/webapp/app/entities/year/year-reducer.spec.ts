...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './year.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_YEAR_LIST actions', async () => {
    ...
    it('dispatches FETCH_YEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_YEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_YEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_YEAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_YEAR actions', async () => {
      const expectedActions = [
        {
