...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOCKSCHEDULE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MOCKSCHEDULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MOCKSCHEDULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MOCKSCHEDULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MOCKSCHEDULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MOCKSCHEDULE actions', async () => {
      const expectedActions = [
        {
