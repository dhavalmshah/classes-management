...
export const EnrollmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="classesManagementApp.enrollment.delete.question">
        <Translate contentKey="classesManagementApp.enrollment.delete.question" interpolate={{ id: enrollmentEntity.id }}>
