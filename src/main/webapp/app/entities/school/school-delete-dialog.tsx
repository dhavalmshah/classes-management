...
export const SchoolDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="classesManagementApp.school.delete.question">
        <Translate contentKey="classesManagementApp.school.delete.question" interpolate={{ id: schoolEntity.id }}>
