...
export const CourseDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="classesManagementApp.course.delete.question">
        <Translate contentKey="classesManagementApp.course.delete.question" interpolate={{ id: courseEntity.id }}>
