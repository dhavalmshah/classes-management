...
export const StudentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="classesManagementApp.student.delete.question">
        <Translate contentKey="classesManagementApp.student.delete.question" interpolate={{ id: studentEntity.id }}>
