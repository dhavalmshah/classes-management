...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINANCEENTRY_LIST actions', async () => {
    ...
    it('dispatches FETCH_FINANCEENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FINANCEENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FINANCEENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FINANCEENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FINANCEENTRY actions', async () => {
      const expectedActions = [
        {
